app.controller('UserController', function ($scope, $log, $state, $mdDialog, $msUI, $translate, utilityService, siteService) {
  ...
  $scope.showCreateEventDialog = function (ev) {
    $mdDialog.show({
      ...
      templateUrl: '/client/app/user/create-event.dialog.html',
  ...
  $scope.showEditEventDialog = function (event) {
    $mdDialog.show({
      ...
      templateUrl: '/client/app/user/edit-event.dialog.html',
      parent: angular.element(document.body),
      //targetEvent: ev,
      clickOutsideToClose: true,
      fullscreen: false,
  ...
  $scope.showAddUserDialog = function (ev) {
    $mdDialog.show({
      ...
      templateUrl: '/client/app/user/add-user.dialog.html',
      parent: angular.element(document.body),
      targetEvent: ev,
      clickOutsideToClose: true,
      fullscreen: false
  ...
  $scope.showAddParticipantGroupDialog = function (ev) {
    $mdDialog.show({
      ...
      templateUrl: '/client/app/user/add-participant-group.dialog.html',
      parent: angular.element(document.body),
      targetEvent: ev,
      clickOutsideToClose: true,
      fullscreen: false,
