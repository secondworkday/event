...
*/
  ...
  $scope.showUploadParticipantsDialog = function (ev, event) {
    $mdDialog.show({
      ...
      templateUrl: '/client/app/user/upload-participants.dialog.html',
      locals: {
        event: event,
  ...
  $scope.showAddParticipantsDialog = function (ev, event) {
    $mdDialog.show({
      ...
      templateUrl: '/client/app/user/add-participants.dialog.html',
      locals: {
        event: event,
        eventSessionsIndex: $scope.eventSessionsIndexer.index,
  ...
  $scope.showCheckInParticipantsDialog = function (ev, eventParticipant) {
    $mdDialog.show({
      ...
      templateUrl: '/client/app/user/checkin-participants.dialog.html',
      locals: {
        eventParticipant: angular.copy(eventParticipant),
  ...
  $scope.showBulkEditParticipantsDialog = function ($event) {
    ...
    $mdDialog.show({
      parent: parentEl,
      targetEvent: $event,
      templateUrl: '/client/app/user/bulk-edit-participants.dialog.html',
      locals: {
        event: event,
        eventSessionsIndex: $scope.eventSessionsIndexer.index,
