app.controller('SystemLibraryOccupationMajorGroupController', function ($scope, $log, FileUploader, utilityService, siteService, occupationMajorGroup) {
  $log.debug("Loading SystemLibraryOccupationMajorGroupController...");
