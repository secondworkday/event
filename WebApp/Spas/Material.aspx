      ...
      app.constant('US_STATES', <%=USStatesArrayJson%> );
        ...
        app.config(['$locationProvider', '$stateProvider', '$urlRouterProvider', '$mdThemingProvider', 'AUTHORIZATION_ROLES', function ($locationProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, AUTHORIZATION_ROLES) {
          ...
          // Now set up the states
            ...
            .state('public.signin', {
              url: '/signin',
              templateUrl: '/client/states/public/signin/signin.html',
            ...
            .state('public.wait', {
              url: '/wait',
              templateUrl: '/client/states/public/wait/wait.html',
            ...
            // APP ------------------------------------------------------------------ //
              ...
              // ** Pre-Authenticated States ** 


              //.state('welcome', {
                //url: "/invite/:authCode",
                //templateUrl: " < % = VersionedUri.MapPath("/signin/welcome.html")%>",
